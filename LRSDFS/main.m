...
for i = 1:21
    ...
    % 计算统计量
    [T2_statistics, SPE_statistics] = calculate_statistics(test_data, D1, D2, 1-1e-8,1e-8 );
    [T2_train, SPE_train] = calculate_statistics(train_data, D1, D2, 1-1e-8,1e-8);
    ...
    saveas(gcf, sprintf('Documents/MATLAB/LRSDFS/plts/statistics/d%02d.svg', i));
end
